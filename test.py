...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', default='model path', type=str, metavar='PATH', help='path to checkpoint')
    parser.add_argument('--root_model', type=str, default='DDAL-main/output/')
    parser.add_argument('--store_name', type=str, default='DDAL-main/output/')
    parser.add_argument('--dir_train_txt', type=str,default="DDAL-main/data/data_txt/iNaturalist18_train.txt")
    parser.add_argument('--dir_test_txt', type=str,default="DDAL-main/data/data_txt/iNaturalist18_val.txt")
    main()
